...
def check_and_clear_task():
    ...
    while True:
        dag_run_status = check_dag_status("airflow_dags_akshai", "manual__2024-02-05T12:35:17.711173+00:00", USERNAME, PASSWORD, DOMAIN)
        if dag_run_status in ["running", "success"]:
            ...
            task_clear(profile="PRO", username=USERNAME, password=PASSWORD, domain=DOMAIN, dag_id="airflow_dags_akshai", dag_run_id="manual__2024-02-05T12:35:17.711173+00:00", task_ids=["pre_dbt", "dbt_seeds_group", "dbt_final_group", "post_dbt"])
            break
